...
/* On Windows, variables that may be in a DLL must be marked specially.  */
	...
	# define DLL_ROUTINE __declspec (dllexport)
	#else
	# define DLL_ROUTINE __declspec (dllimport)
	#endif
#else
	# define DLL_ROUTINE
#endif
...
#endif
extern DLL_ROUTINE char *gettext (const char *__msgid)
...
#endif
extern DLL_ROUTINE char *dgettext (const char *__domainname, const char *__msgid)
...
#endif
extern DLL_ROUTINE char *dcgettext (const char *__domainname, const char *__msgid,
                        int __category)
...
#endif
extern DLL_ROUTINE char *ngettext (const char *__msgid1, const char *__msgid2,
                       unsigned long int __n)
...
#endif
extern DLL_ROUTINE char *dngettext (const char *__domainname,
...
#endif
extern DLL_ROUTINE char *dcngettext (const char *__domainname,
                         const char *__msgid1, const char *__msgid2,
                         unsigned long int __n, int __category)
...
#endif
extern DLL_ROUTINE char *textdomain (const char *__domainname)
...
#endif
extern DLL_ROUTINE char *bindtextdomain (const char *__domainname, const char *__dirname)
...
#endif
extern DLL_ROUTINE char *bind_textdomain_codeset (const char *__domainname,
                                      const char *__codeset)
